...
- Адміністратори мають доступ до вмісту, завантаженого користувачами. Вони можуть контролювати дані та забезпечувати відповідність політикам.
Контроль аналізу контенту:
...
- Адміністратори можуть налаштовувати параметри та налаштування системи. Це включає в себе налаштування алгоритмів аналізу, політик збереження даних і параметрів інтеграції.
